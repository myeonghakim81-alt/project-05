...
export const dialogues: DialogueScript[] = [
  {
    ...
    targetVocabularyIds: ['word-reservation', 'word-available', 'word-recommend', 'word-crowded', 'word-convenient', 'word-menu', 'word-bill', 'word-dessert', 'word-portion'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-checkin', 'word-reservation', 'word-available', 'word-key', 'word-lobby', 'word-luggage', 'word-checkout', 'word-view'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-order', 'word-recommend', 'word-available', 'word-refill', 'word-barista'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-nearby', 'word-straight', 'word-turn', 'word-corner', 'word-map', 'word-distance'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-ticket', 'word-platform', 'word-fare', 'word-delay', 'word-aisle'],
    turns: [
      {
        id: 'turn-1',
  ...
  // --- Level 3 ---
  {
    ...
    targetVocabularyIds: ['word-job', 'word-work', 'word-family', 'word-appointment', 'word-relative', 'word-salary', 'word-colleague', 'word-cancel', 'word-sibling', 'word-promotion', 'word-confirm'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-hobby', 'word-favorite', 'word-prefer', 'word-weather', 'word-rain', 'word-paint', 'word-dislike', 'word-forecast', 'word-craft', 'word-preference', 'word-temperature'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-usually', 'word-wake-up', 'word-schedule', 'word-brother', 'word-routine', 'word-nap'],
    turns: [
      {
        id: 'turn-1',
  ...
  // --- Level 4 ---
  {
    ...
    targetVocabularyIds: ['word-party', 'word-invite', 'word-friend', 'word-excited', 'word-buddy', 'word-celebrate', 'word-acquaintance', 'word-attend'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-ask', 'word-favor', 'word-mistake', 'word-apologize', 'word-permission', 'word-forgive', 'word-assist', 'word-excuse'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-weekend', 'word-relax', 'word-happen', 'word-feel', 'word-experience', 'word-calm', 'word-errand', 'word-memory', 'word-emotion', 'word-picnic', 'word-adventure'],
    turns: [
      {
        id: 'turn-1',
  ...
  // --- Level 5 ---
  {
    ...
    targetVocabularyIds: ['word-interesting', 'word-curious', 'word-agree', 'word-by-the-way', 'word-chat', 'word-fascinating', 'word-mention', 'word-topic', 'word-enthusiastic', 'word-anyway'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-genre', 'word-actor', 'word-song', 'word-delicious', 'word-concert', 'word-recipe', 'word-album', 'word-cuisine'],
    turns: [
      {
        id: 'turn-1',
  ...
  },
  {
    ...
    targetVocabularyIds: ['word-abroad', 'word-memorable', 'word-tradition', 'word-custom', 'word-spicy', 'word-festival', 'word-souvenir', 'word-ceremony', 'word-itinerary'],
    turns: [
      {
        id: 'turn-1',
